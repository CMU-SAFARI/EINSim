...
Eigen::Matrix< ET, Eigen::Dynamic, 1 > einsim::repetition::encode(Eigen::Matrix< ET, Eigen::Dynamic, 1 > data_word)
{
	// Encoding: Ax = b -> [16*Nx16][16] = [16*N]
	return bit_mapping * data_word;
}

Eigen::Matrix< ET, Eigen::Dynamic, 1 > einsim::repetition::decode(Eigen::Matrix< ET, Eigen::Dynamic, 1 > code_word)
{
	// Decoding: x = A^-1 b
